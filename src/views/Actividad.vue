    ...
    .row.mb-5.justify-content-center.align-items-center.align-items-lg-stretch
      .col-6.col-md-4.col-lg-3.mb-4.mb-md-0(data-aos="fade-right")
        .tarjeta.h-100.d-flex.align-items-center.p-4
          figure
            img(src="@/assets/template/Cuestionario.svg", alt="")
      .col-12.col-md-8.col-lg-9(data-aos="fade-left")
        .titulo-segundo
          h2 Contextualización del gestionamiento de los equipos de red
        p.mb-4 Repasar los conceptos estudiados en el componente formativo.
